...
public final class Constants {
    ...
    public static class DriveConstants{
        ...
        public static final int REAR_RIGHT_DRIVE_PORT = 8;
        public static final int FRONT_RIGHT_DRIVE_PORT = 5;
        public static final int FRONT_LEFT_DRIVE_PORT = 1;
        public static final int REAR_LEFT_DRIVE_PORT = 4;

        public static final int REAR_RIGHT_TURN_PORT = 7;
        public static final int FRONT_RIGHT_TURN_PORT = 6;
        public static final int FRONT_LEFT_TURN_PORT = 2;
        public static final int REAR_LEFT_TURN_PORT = 3;

        public static final int REAR_RIGHT_ENCODER_PORT = 9;
        public static final int FRONT_RIGHT_ENCODER_PORT = 12;
